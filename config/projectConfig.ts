...
export const projectName: string = 'Electron 脚手架'; // 项目名
export const prefix: string | undefined = 'jsbi-web'; // 项目前缀 与 页面缓存相关
export const sysId: string = 'jsbi-web'; // 子系统id 与 菜单加载相关
